...
//        this.height = displayMetrics.heightPixels;
        ...
        rel_three.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mainAcdsctivity.bottomNavigationView.getMenu().findItem(R.id.navigation_workout).setChecked(true);
            }
        });
        this.rel_four=inflate.findViewById(R.id.rel_four);
        rel_four.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), FragmentActivity.class);
                startActivity(intent);
                mainAcdsctivity.bottomNavigationView.getMenu().findItem(R.id.action_food).setChecked(true);
            }
        });
        this.rel_one=inflate.findViewById(R.id.rel_five);
        rel_one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mainAcdsctivity.openReminderFragment();
                mainAcdsctivity.bottomNavigationView.getMenu().findItem(R.id.navigation_remider).setChecked(true);
            }
        });
        this.rel_two=inflate.findViewById(R.id.rel_six);
        rel_two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mainAcdsctivity.openCalculatorFragment();
                mainAcdsctivity.bottomNavigationView.getMenu().findItem(R.id.action_cal).setChecked(true);
            }
        });
